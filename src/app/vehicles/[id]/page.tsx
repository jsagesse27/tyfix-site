...
import { ArrowLeft, Phone, MessageCircle, ShieldCheck, ExternalLink, Zap, Palette, Settings2, Gauge, Calendar } from 'lucide-react';
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${v.year} ${v.make} ${v.model} | TyFix Auto Sales`,
    description: `${v.year} ${v.make} ${v.model} for ${formatPrice(v.price)}. ${v.condition_notes || 'Quality inspected vehicle.'} Cash price, no hidden fees.`,
  };
}
...
export default async function VehicleDetailPage({ params }: PageProps) {
  ...
  const [vehicleRes, settingsRes, contentRes] = await Promise.all([
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2">
              {/* Photo Gallery */}
              <VehicleGallery photos={photos} alt={vehicleTitle} />
              ...
              <div className="lg:hidden mt-6 mb-8">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <h1 className="text-3xl font-black text-gray-900">{vehicleTitle}</h1>
              ...
              {vehicle.condition_notes && (
                <div className="mt-8">
                  <h2 className="text-xl font-bold text-gray-900 mb-3">Condition Notes</h2>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                ...
                <div className="hidden lg:block admin-card">
                  ...
                  <h1 className="text-2xl font-black text-gray-900 mb-1">{vehicleTitle}</h1>
