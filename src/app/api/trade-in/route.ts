...
export async function POST(request: Request) {
  try {
    ...
    const { name, phone, email, vin, year, make, model, trim, engine, body_type, transmission, fuel_type, drivetrain, cylinders, doors, mileage, exteriorColor, isOriginalOwner, ownershipDuration, exteriorLook, dentsScratches, windshield, tireCondition, rust, interiorCondition, odors, warningLights, workingFeatures, lastOilChange, accidentHistory, notes } = body;
